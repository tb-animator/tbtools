...
def track(*args):
    ## a tracking camera that should have a seamless transition between the
    # default perp view and the tracking camera
    # usage
    #
    # import tb_trackingCam as tb_trackingCam
    # pick a new tracking target and swap to tracking camera
    # tb_trackingCam.track("retarget")
    # return to perspective view
    # tb_trackingCam.track("persp")
    # swap to tracking camera
    # tb_trackingCam.track("tracker")
    #
